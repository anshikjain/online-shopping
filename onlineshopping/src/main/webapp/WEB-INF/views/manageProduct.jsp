		...
		<div class="col-md-offset-2 col-md-8">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<sf:form class="form-horizontal" modelAttribute="product" action="${pageContext.request.contextPath}/manage/product" method="POST" enctype="multipart/form-data">
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        ...
	        <sf:form id="categoryForm" class="form-horizontal" modelAttribute="category" action="${pageContext.request.contextPath}/manage/category" method="POST">
